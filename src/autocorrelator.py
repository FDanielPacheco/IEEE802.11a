...
import autocorrelator_epy_block_0 as epy_block_0  # embedded python block
import time
import threading
...
class autocorrelator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.trigger_mag = trigger_mag = -60
        ...
        self.p_f = blocks.probe_signal_f()
        ...
        def _pcfo_probe():
          while True:
            ...
            try:
              try:
                self.doc.add_next_tick_callback(functools.partial(self.set_pcfo,val))
              except AttributeError:
                self.set_pcfo(val)
            except AttributeError:
              pass
            time.sleep(1.0 / (samp_rate))
        _pcfo_thread = threading.Thread(target=_pcfo_probe)
        _pcfo_thread.daemon = True
        _pcfo_thread.start()
        self._trigger_mag_range = Range(-120, 0, 1, -60, 50)
        self._trigger_mag_win = RangeWidget(self._trigger_mag_range, self.set_trigger_mag, "Trigger Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._trigger_mag_win)
        ...
        self.qtgui_time_sink_x_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, trigger_level, 0, 0, "")
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'Frame', "frame_start")
        self.blocks_tag_debug_0.set_display(True)
        self.blocks_sample_and_hold_xx_0 = blocks.sample_and_hold_ff()
        self.blocks_rotator_cc_0 = blocks.rotator_cc(pcfo, True)
        self.blocks_plateau_detector_fb_0 = blocks.plateau_detector_fb(plateau_level, trigger_level)
        self.blocks_null_sink_0_0 = blocks.null_sink(gr.sizeof_gr_complex*1)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff((-1))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((1/16))
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_plateau_detector_fb_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_sample_and_hold_xx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.p_f, 0))
        self.connect((self.blocks_plateau_detector_fb_0, 0), (self.blocks_sample_and_hold_xx_0, 1))
        self.connect((self.blocks_plateau_detector_fb_0, 0), (self.epy_block_0, 2))
        self.connect((self.blocks_rotator_cc_0, 0), (self.blocks_null_sink_0_0, 0))
        self.connect((self.blocks_sample_and_hold_xx_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        self.connect((self.blocks_sample_and_hold_xx_0, 0), (self.epy_block_0, 1))
        ...
        self.connect((self.epy_block_0, 0), (self.blocks_rotator_cc_0, 0))
        self.connect((self.epy_block_0, 0), (self.blocks_tag_debug_0, 0))
    ...
    def get_trigger_mag(self):
        return self.trigger_mag

    def set_trigger_mag(self, trigger_mag):
        self.trigger_mag = trigger_mag
    ...
    def set_trigger_level(self, trigger_level):
        ...
        self.blocks_plateau_detector_fb_0.set_threshold(self.trigger_level)
        self.qtgui_time_sink_x_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, self.trigger_level, 0, 0, "")
    ...
    def set_pcfo(self, pcfo):
        self.pcfo = pcfo
        self.blocks_rotator_cc_0.set_phase_inc(self.pcfo)
