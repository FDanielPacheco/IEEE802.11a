...
class main(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.basic_block(power_thres=trigger_power, window_size=160)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/pacheco/Documents/FEUP/MYREG/DigitalCommunications/IEEE802.11a/dataset/Sample3_20MHz_Channel100.bin', False, 50000000, 0)
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.qtgui_sink_x_0, 0))
